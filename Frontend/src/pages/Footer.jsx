...
function Footer() {
    return (<>
        < footer className="bg-gray-900" >
            <div className="max-w-screen-xl h-full px-4 pt-5 pb-3 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center text-teal-300 sm:justify-start">
                            <img className='rounded-full h-40 mix-blend-color-burn' src='https://th.bing.com/th?id=OIP.xXsFM1rQUZ80OEAuKLEZbQHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2' />
                            <path
                        ...
                        <p
                            className="w-full mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left"
                        ><pre>
                                Hello, Users<br />
                                Welcome to <b>ShopAze</b>, where we believe in enhancing your shopping experience<br />
                                with convenience and quality. Since our inception, we've been committed to bringing you<br />
                                the best products at unbeatable prices, all at the click of a button. Whether you're looking<br />
                                for the latest in fashion, cutting-edge electronics, or everyday essentials, we've got you covered.<br />
                                Join our community of satisfied customers and explore a world where shopping is more than just<br />
                                a transaction—it's a journey of discovery and delight. Stay connected with us through our social<br />
                                media channels for exclusive updates, offers, and more. Thank you for choosing ShopAze, where<br />
